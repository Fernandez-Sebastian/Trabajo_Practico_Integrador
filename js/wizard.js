...
function exportarPDF() {
  let doc = new jsPDF();
  doc.text(nombrePaso3.value, 10, 10);
  doc.text(mailPaso3.value, 10, 22);
  doc.text(motivoPaso3.value, 10, 34);
  doc.text(reclamoPaso3.value, 10, 46);
  doc.save("Reclamo " + nombrePaso3.value);
}

imprimir.addEventListener("click", exportarPDF);
